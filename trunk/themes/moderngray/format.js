// Code copied from phpBB, and edited to work with YaPCaS
// bbCode control by
// subBlue design
// www.subBlue.com
...
i_help = "&bbc.i.help;";
u_help = "&bbc.u.help;";
quote_help = "&bbc.q.help;";

// Define the bbCode tags
bbcode = new Array ();
bbtags = new Array (&bbc.jsarray;); 
imageTag = false;
...
/*function checkForm () {
	...
	if (document.post.message.value.length < 2) {
		formErrors = "Je moet een bericht typen bij het plaatsen van een reactie.";
	}
	if (formErrors) {
		alert (formErrors);
		return false;
...
function bbstyle (bbnumber) {
	...
	theSelection = false;
	bblast = 0;
	// Close all open tags & default button names and return;
	if (bbnumber == -1) {
		while (bbcode[0]) {
